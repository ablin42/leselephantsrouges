	...
	return (
		<>
			<div className="container container-front" id="container-login">
				...
				>
					<div className="row">
						...
						<input placeholder="Email" type="email" id="login-email" name="email" value="" required />
			...
			<div className="container container-front" id="container-lostpw">
				...
				<form className="col-md-6 offset-md-3 text-center" id="lostpw" data-lostpw="true" method="POST" action="/api/auth/lostpw">
					<div className="row">
